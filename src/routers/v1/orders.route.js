...
router
  .post('/create-order', isAuthorized, validateSchema(createOrderDto), createOrderController)
  .get('/get-all-orders', isAuthorized, getAllOrdersByUserController)
  .get('/get-order-by-id/:id', isAuthorized, getOrderByIdController)
  .put('/update-order-by-id/:id', isAuthorized, validateSchema(updateOrderDto), updateOrderByIdController)
