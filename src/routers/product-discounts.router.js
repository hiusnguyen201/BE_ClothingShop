...
router
  ...
  .get('/get-product-discount-by-id/:id', isAuthorizedAndHasPermission, getProductDiscountByIdController)
  .post(
  ...
  .delete('/remove-product-discount-by-id/:id', isAuthorizedAndHasPermission, removeProductDiscountByIdController);
