 ...
 * @returns
 */
export const newPaymentRepository = (data) => {
 ...
 * @returns
 */
export async function insertPaymentRepository(data, session) {
 ...
 * @returns
 */
export const createPaymentRepository = async (data, session) => {
 ...
 * @returns
 */
export const savePaymentRepository = async (payment, session) => {
 ...
 * @returns
 */
export const getPaymentByIdRepository = async (paymentId) => {
 ...
 * @returns
 */
export async function updatePaymentByIdRepository(paymentId, data, session) {
