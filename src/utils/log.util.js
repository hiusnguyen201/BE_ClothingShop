...
class LogUtils {
  static log = (type, tag, message, object = null) => {
    ...
    let logMethod = console[type] ?? console.log;
    ...
    if (type === 'info') {
      ...
      logColor = COLOR_ERROR;
    } else if (type === 'debug') {
      logColor = COLOR_DEBUG;
  ...
  static success(tag, message, object = null) {
    this.log('success', tag, message, object);
  }
